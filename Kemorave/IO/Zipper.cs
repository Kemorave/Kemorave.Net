...
namespace Kemorave.IO
{
    public class Zipper : Progress<int>
    {
        ...
        public void ExtractToDirectory(ZipArchive source)
        {
            ...
            DirectoryInfo directoryInfo = Directory.CreateDirectory(DestinationFilePath.Substring(0, DestinationFilePath.Length - DefaultExtension.Length));
        ...
        {
            private get => _DestinationFilePath;
            set
            {
                ...
                if (!_DestinationFilePath.EndsWith(DefaultExtension))
                {
                    _DestinationFilePath += DefaultExtension;
                }
        ...
        public const string DefaultExtension = ".GZip";
